...
import com.rizkynugraha.cari_kos.Destination;
import com.rizkynugraha.cari_kos.FilterDestination;
...
public class AdapterDestination extends RecyclerView.Adapter<AdapterDestination.MyViewHolder> implements Filterable{
    ...
    List<Destination> destinationFilter;
    private Context context;
    private RecyclerViewClickListener mListener;
    FilterDestination filter;

    public AdapterDestination(List<Destination> transportasi, Context context, RecyclerViewClickListener listener) {
